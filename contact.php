...
<div class="link" style="margin-right:25px;"><a href="." class="white">HOME</a></div><div class="link" style="margin-right:15px"><a href="events.php" class="white" style="border-bottom: 1px solid #fff; color: #fff; position: relative;">EVENTS</a></div><div class="link" style="margin-right:15px"><a href="ranking.php" class="white">RANKING</a></div>
...
<div class="main_frame"><div style="padding-top:250px; text-align:center; font-size:18px">Coming soon</div></div>
